...
public class DocumentationDictionary {
    ...
    public DocumentationDictionary ( String referenceName, Object obj ) throws XMLException {
        ...
        if (!isObject) {
            ...
            for (Field currentField : obj.getClass().getFields()) {
                //for (int i = 0; i < f.length; i++) {
                //Field currentField = f[i];

                /*  This condition is added by Bilal.. for javax.json.JsonValue it was giving stack overflow exception
                 * JsonValue class is having fields of its own type.. So it goest to recursive 
                 * To avoid the recursion this condition is being used */
                if (!currentField.getType().isAssignableFrom(obj.getClass())) {
            ...
            for (int i = 0; i < m.length; i++) {
                ...
                // condition added by Bilal (prefix.getChars() failed) 
